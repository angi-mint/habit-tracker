...
<template>
    <div class="habit-wrapper" :key="reloader">
        ...
        <TrackButton @reload="handleHabitTracked(HabitProps.id)" :id="HabitProps.id" :color="HabitProps.color" :percentage="percentage" :size="iconSize" :key="reloader"></TrackButton>
    </div>
</template>
