...
<template>
    <div @click="trackHabit">
        <svg v-if="percentage !== 100 && percentage !== 0" :width="HabitTrack.size" :height="HabitTrack.size" viewBox="0 0 36 36" class="tracker-progress">
        ...
        <svg v-else-if="percentage === 100" class="tracker-svg" xmlns="http://www.w3.org/2000/svg" :width="HabitTrack.size" :height="HabitTrack.size" fill="currentColor" viewBox="0 0 16 16">
